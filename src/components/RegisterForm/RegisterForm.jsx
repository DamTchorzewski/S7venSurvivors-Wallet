        ...
        <div className={css.form__container}>
          <Form className={css.form}>
            ...
            <div className={css.input__container}>
              {touched.email && errors.email ? <p className={css.errors}>{errors.email}</p> : null}

              <IconEmail className={css.input__icon} style={{ color: '#e0e0e0' }} />
            ...
            <div className={css.input__container}>
              {touched.password && errors.password ? (
                <p className={css.errors}>{errors.password}</p>
              ) : null}

              <IconLock className={css.input__icon} style={{ color: '#e0e0e0' }} />
              ...
              <span onClick={handlePasswordVisibility} className={css.password__visibility__toggle}>
                {showPassword ? (
            ...
            <div className={css.input__container}>
              {touched.confirmPassword && errors.confirmPassword ? (
                <p className={css.errors}>{errors.confirmPassword}</p>
              ) : null}
            ...
            <div className={css.input__container}>
              {touched.name && errors.name ? <p className={css.errors}>{errors.name}</p> : null}

              <IconName className={css.input__icon} style={{ color: '#e0e0e0' }} />
            ...
            <div className={css.btn__cnt}>
              <button type="submit" className={css.main__btn} disabled={!isValid && !dirty}>
                Register
              </button>
              <Link to="/S7venSurvivors-Wallet/">
                <button type="button" className={css.scd__btn}>
                  Log in
                </button>
              </Link>
            </div>
